...
For each of the causal graphs below, identify the set of variables needed to block noncausal paths (if possible). Any $U$ variables displayed in the graphs are unobserved/unmeasured.
